...
# -----------------------------
# IMU SETUP (LSM6DSOX / LSM6DSL)
# -----------------------------
bus = smbus2.SMBus(1)

IMU_ADDR = 0x6A     # or 0x6B depending on hardware
CTRL1_XL = 0x10
CTRL2_G  = 0x11
OUTX_L_G = 0x22
OUTX_L_A = 0x28
...
def read_imu():
    ...
    # Gyro conversion for 2000 dps mode:
...
while time.time() < end_time:
    ...
    if t > next_cam:
        picam.capture_array()   # discard frame; timestamp only
